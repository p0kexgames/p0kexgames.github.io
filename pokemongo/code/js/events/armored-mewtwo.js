  ...
  var s = 'Jul 10 2019 13:00:00 GMT-0700'; var e = 'Jul 31 2019 13:00:00 GMT-0700';
 ...
 /* new_offset */
  ...
  //alert(d);
  if ( document.getElementById('armored_mewtwo_raid_event_mz_l') ) { document.getElementById('armored_mewtwo_raid_event_mz_l').innerHTML = d; } 
  ...
  if ( document.getElementById('armored_mewtwo_raid_event_mz_countdown') ) {
    stop_clock_id = initializeClock('armored_mewtwo_raid_event_mz_countdown', deadline, 0, f);
    ...
    document.getElementById('armored_mewtwo_raid_event_mz_time').innerHTML = local_date_string;
  }