  ...
  var s = 'Jul 14 2019 16:00:00'; var e = 'Jul 14 2019 19:00:00';
 ...
 /* new_offset */
  ...
  //alert(d);
  if ( document.getElementById('entei_raid_day_mz_l') ) { document.getElementById('entei_raid_day_mz_l').innerHTML = d; } 
  ...
  if ( document.getElementById('entei_raid_day_mz_countdown') ) {
    stop_clock_id = initializeClock('entei_raid_day_mz_countdown', deadline, 0, f);
    ...
    document.getElementById('entei_raid_day_mz_time').innerHTML = local_date_string;
  }
