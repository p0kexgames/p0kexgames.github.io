  ...
  var s = 'Aug 5 2019 18:00:00 GMT-0700'; var e = 'Aug 12 2018 01:00:00 GMT-0700';
 ...
 /* new_offset */
  ...
  //alert(d);
  if ( document.getElementById('blanche_quest_event_mz_l') ) { document.getElementById('blanche_quest_event_mz_l').innerHTML = d; } 
  ...
  if ( document.getElementById('blanche_quest_event_mz_countdown') ) {
    stop_clock_id = initializeClock('blanche_quest_event_mz_countdown', deadline, 0, f);
    ...
    document.getElementById('blanche_quest_event_mz_time').innerHTML = local_date_string;
  }
