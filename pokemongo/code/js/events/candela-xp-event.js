  ...
  var s = 'Jul 9 2019 13:00:00 GMT-0700'; var e = 'Jul 16 2019 13:00:00 GMT-0700';
 ...
 /* new_offset */
  ...
  //alert(d);
  if ( document.getElementById('bonus_xp_event_2019_mz_l') ) { document.getElementById('bonus_xp_event_2019_mz_l').innerHTML = d; } 
  ...
  if ( document.getElementById('bonus_xp_event_2019_mz_countdown') ) {
    stop_clock_id = initializeClock('bonus_xp_event_2019_mz_countdown', deadline, 0, f);
    ...
    document.getElementById('bonus_xp_event_2019_mz_time').innerHTML = local_date_string;
  }
