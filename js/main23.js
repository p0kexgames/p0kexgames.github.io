...
$(".aviso").html(" ");
 ...
 $(".tablebe4").attr("title", "Fastball");
   ...
   $(".fb-like-in").html( '<div class="fb-like-'+myPokeNome.replace("Shiny ", "").replace("Mega ", "")+'"> <div class="fb-like" data-action="like" data-href="http://mediaspxg.blogspot.com/2017/08/'+myPokeNome.replace(".", "").replace("Shiny ", "").replace("Mega ", "").toLowerCase()+'.html" data-layout="button_count" data-share="true" data-show-faces="false"></div> </div>' );
   $(".rating-modal").html( '<div class="rw-ui-container" data-title="'+myPokeNome.replace("Shiny ", "").replace("Mega ", "")+'"></div>' );
