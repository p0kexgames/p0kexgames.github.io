...
// </FIM PESQUISA LATERAL
  ...
  //// FORMATA O CAMPO DOS LOOTS PARA EXIBIR CORRETAMENTE
     var text0 = myPokeLoots.split('//');
     len = text0.length;
	 
     for( j=0; j<len; j++ ) {
		 var text01 = text0[1].split('--');
		 len = text01.length;
		 for( k=0; k<len; k++ ) {          
		  var texto = '.'+text01[0]+' { background: url(https://p0kexgames.github.io/images/'+text01[0]+') no-repeat scroll 0 4px transparent; }';
