...
$(".aviso").html(" ");
  ...
  if (myPokeDificuldade === 'Dimensional zone') {
       ...
       text = "<div class='dificuldade'>";
        text += "Esse Pokemon poderá ser adquirido através da Dimensional Zone no TC. (depende das rotações)";
       text += "</div>";
       $(".aviso").append( text );
       $(".aviso").addClass( 'show' );
  ...
  if (myPokeDificuldade === 'Embedded tower') {
       ...
       text = "<div class='dificuldade'>";
        text += "Esse Pokemon poderá ser adquirido através da Embedded tower Quest em Phenac.";
       text += "</div>";
       $(".aviso").append( text );
       $(".aviso").addClass( 'show' );
       $(".aviso").removeClass( 'hide' );
  ...
  if (myPokeDificuldade === 'Drop') {
       ...
       text = "<div class='dificuldade'>";
        text += "Esse Pokemon poderá ser adquirido por drop da própria mega evolução em Phenac.";
       text += "</div>";
       $(".aviso").append( text );
       $(".aviso").addClass( 'show' );
       $(".aviso").removeClass( 'hide' );
  ...
  if (myPokeDificuldade === 'Clan') {
       ...
       text = "<div class='dificuldade'>";
        text += "Esse Pokemon não pode ser capturado, para ter um basta ir ao respectivo clan no TC com sua versao normal +20 mais o dinheiro necessário.";
       text += "</div>";
       $(".aviso").append( text );
       $(".aviso").addClass( 'show' );
       $(".aviso").removeClass( 'hide' );
  ...
  if (myPokeDificuldade === 'Eventos') {
       ...
       text = "<div class='dificuldade'>";
        text += "Esse Pokemon está disponível somente em eventos. Não possui média.";
       text += "</div>";
       $(".aviso").append( text );
       $(".aviso").addClass( 'show' );
       $(".aviso").removeClass( 'hide' );
