...
$(".aviso").html(" ");
  ...
  if (myPokeDificuldade === 'Dimensional zone') {
       ...
       text = "<div class='dificuldade'>";
        text += "<i class='fa fa-exclamation-circle'></i> Esse Pokemon poderá ser adquirido através da Dimensional Zone no TC. (depende das rotações)";
       text += "</div>";
       $(".aviso").append( text );
       $(".aviso").addClass( 'show' );
  ...
  if (myPokeDificuldade === 'Embedded tower') {
       ...
       text = "<div class='dificuldade'>";
        text += "<i class='fa fa-exclamation-circle'></i> Esse Pokemon poderá ser adquirido através da Embedded tower Quest em Phenac.";
       text += "</div>";
       $(".aviso").append( text );
       $(".aviso").addClass( 'show' );
       $(".aviso").removeClass( 'hide' );
  ...
  if (myPokeDificuldade === 'Cyber world') {
       ...
       text = "<div class='dificuldade'>";
        text += "<i class='fa fa-exclamation-circle'></i> Esse Pokemon poderá ser adquirido somente com a quest Cyber world completa.";
       text += "</div>";
       $(".aviso").append( text );
       $(".aviso").addClass( 'show' );
       $(".aviso").removeClass( 'hide' );
  ...
  if (myPokeDificuldade === 'Clan') {
       ...
       text = "<div class='dificuldade'>";
        text += "<i class='fa fa-warning'></i> Esse Pokemon não pode ser capturado, para ter um basta ir ao respectivo clan no TC com sua versao normal +20 mais o dinheiro necessário.";
       text += "</div>";
       $(".aviso").append( text );
       $(".aviso").addClass( 'show' );
       $(".aviso").removeClass( 'hide' );
  ...
  if (myPokeDificuldade === 'Inicial') {
       ...
       text = "<div class='dificuldade'>";
        text += "<i class='fa fa-warning'></i> Esse Pokemon não pode ser capturado. Somente pode ter um na quest da Stacy ou escolhendo como inicial";
       text += "</div>";
       $(".aviso").append( text );
       $(".aviso").addClass( 'show' );
       $(".aviso").removeClass( 'hide' );
  ...
  if (myPokeDificuldade === 'Agatha quest') {
       ...
       text = "<div class='dificuldade'>";
        text += "<i class='fa fa-warning'></i> Esse Pokemon não pode ser capturado. Para ter um deverá completar a Agatha Quest";
       text += "</div>";
       $(".aviso").append( text );
       $(".aviso").addClass( 'show' );
       $(".aviso").removeClass( 'hide' );
