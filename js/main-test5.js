...
ShinysMegasArray = [
 ...
 {shiny:"Alolan", nome:"Muk",  numero:"89-2",  level:"0",   ball1:"Nenhuma",   ball2:"Nenhuma", 
  ...
  {shiny:"Earth", nome:"Wormadam",  numero:"413-1",  level:"0",   ball1:"Nenhuma",   ball2:"Nenhuma", 
   clan1:"Naturia",   clan2:"Nenhum",   tipo1:"Inseto",   tipo2:"Terra", 
   regiao:"Sinoh",   geracao:"4",   dificuldade:"Nightmare World", xpcaught:"0", pricenpc:"0",
   fast:"no", heavy:"no", 
   preevo2:"no", preevo1:"no", evo1:"no", evo2:"no", npreevo2:"no", npreevo1:"no", nevo1:"no", nevo2:"no", 
   mapas:'no',  vip: "yes", 
   moves:"no", 
   loots:"no", evoStone:"", boost:"", booStone:"", habilidades:""},
  {shiny:"Steel", nome:"Wormadam",  numero:"413-2",  level:"0",   ball1:"Nenhuma",   ball2:"Nenhuma", 
   clan1:"Naturia",   clan2:"Nenhum",   tipo1:"Inseto",   tipo2:"Metal", 
   regiao:"Sinoh",   geracao:"4",   dificuldade:"Nightmare World", xpcaught:"0", pricenpc:"0",
   fast:"no", heavy:"no", 
   preevo2:"no", preevo1:"no", evo1:"no", evo2:"no", npreevo2:"no", npreevo1:"no", nevo1:"no", nevo2:"no", 
   mapas:'no',  vip: "yes", 
...
$(".aviso").html(" ");
  ...
  if (myPokeHabilidades !== "") {
	  ...
	  $(".habilidadesh5").css('display', 'block');
      } else {
	  $("p.habilidades").css('display', 'none');
	  $(".habilidadesh5").css('display', 'none');
      }
