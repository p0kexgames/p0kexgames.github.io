  ...
  for (i = 0; i < fLen; i++) {
   ...
   var myPokeLoots = pokesarray[i].loots;
     ...
     for( var j=0; j<loots3.length; j++ ) {    
  		var loots2 = loots3[1].trim().split('--');
  		  
    		 for( var k=0; k<loots2.length; k++ ) {    
  			$("body").append( "ul.loots li."+loots2[0].replace(/[ ]/g,'%20')+" { background: url(https://p0kexgames.github.io/images/"+loots2[0].replace(/[ ]/g,'%20')+".png) no-repeat scroll 0 4px transparent; }<br/>" );
  		 }
     }
