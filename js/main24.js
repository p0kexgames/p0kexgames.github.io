...
$(".aviso").html(" ");
 ...
 $(".tablebe4").attr("title", "Fastball");
   ...
   var myPokeNome2 = myPokeNome.replace("Shiny ", "").replace("Mega ", "").replace("Mega (X) ", "").replace("Mega (Y) ", "").replace("Baby ", "").replace("(2) ", "").replace("(3) ", "").replace("(4) ", "").replace("(5) ", "").replace("(6) ", "").replace("(7) ", "").replace("(8) ", "").replace("Minun and ", "").replace("Big ", "").replace("Crystal ", "").replace("Giant ", "");
