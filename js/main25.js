...
ShinysMegasArray = [
  ...
  {shiny:"Shiny", nome:"Zubat",  numero:"41-1",  level:"10",   ball1:"Nenhuma",   ball2:"Nenhuma", 
   ...
   regiao:"Kanto",   geracao:"1",   dificuldade:"Caught", xpcaught:"0", pricenpc:"unseleable",
   fast:"no", heavy:"no", 
   preevo2:"no", preevo1:"no", evo1:"Shiny Golbat", evo2:"Shiny Crobat", npreevo2:"no", npreevo1:"no", nevo1:"31-1", nevo2:"169-1", 
   mapas:'no',  vip: "no", 
...
$(".aviso").html(" ");
 ...
 $(".tablebe4").attr("title", "Fastball");
   ...
   $(".fb-like-in").html( '<div class="fb-like-'+myPokeNome.replace("Shiny ", "").replace("Mega ", "").replace("Mega (X) ", "").replace("Mega (Y) ", "").replace("Baby ", "").replace("(2) ", "").replace("(3) ", "").replace("(4) ", "").replace("(5) ", "").replace("(6) ", "").replace("(7) ", "").replace("(8) ", "").replace("Minun and ", "").replace("Big ", "").replace("Crystal ", "").replace("Giant ", "")+'"> <div class="fb-like" data-action="like" data-href="http://mediaspxg.blogspot.com/2017/08/'+myPokeNome.replace(".", "").replace("Shiny ", "").replace("Mega ", "").replace("Mega (X) ", "").replace("Mega (Y) ", "").replace("Baby ", "").replace("(2) ", "").replace("(3) ", "").replace("(4) ", "").replace("(5) ", "").replace("(6) ", "").replace("(7) ", "").replace("(8) ", "").replace("Minun and ", "").replace("Big ", "").replace("Crystal ", "").replace("Giant ", "").toLowerCase()+'.html" data-layout="button_count" data-share="true" data-show-faces="false"></div> </div>' );
   $(".rating-modal").html( '<div class="rw-ui-container" data-title="'+myPokeNome.replace("Shiny ", "").replace("Mega ", "").replace("Mega (X) ", "").replace("Mega (Y) ", "").replace("Baby ", "").replace("(2) ", "").replace("(3) ", "").replace("(4) ", "").replace("(5) ", "").replace("(6) ", "").replace("(7) ", "").replace("(8) ", "").replace("Minun and ", "").replace("Big ", "").replace("Crystal ", "").replace("Giant ", "")+'"></div>' );
